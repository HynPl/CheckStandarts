...
namespace CheckStandarts {
    public class GCollapse : Control {
       ...
       readonly Image imageDown, imageUp, imageLogo,  imageOk, imageWarling, imageWrong;
        Point ptImageDown;
        #endregion
        public GCheckState.State currentState;
     ...
     //       Warling,
        ...
        public GCollapse() {
            ...
            ptImageDown=new Point(Width-40,5);

            imageDown=Properties.Resources.down;
            imageUp=Properties.Resources.up;
            imageLogo=Properties.Resources.Stairs;

            imageOk=Properties.Resources.Done;
            imageWarling=Properties.Resources.Warning;
            imageWrong=Properties.Resources.Wrong;
            Collapsed=true;
	    }
        ...
        protected override void OnResize(EventArgs e) {
		    ...
		    textY = Size.Height/2;
            buttonSize = new Size(Width-3, Height-4);
            Size = new Size(Width, 37);
            ptImageDown=new Point(buttonSize.Width-32,7);
		    Refresh();
	    }
        ...
        protected override void OnMouseUp(MouseEventArgs e) {
		    base.OnMouseUp(e);
		    if (currentMouseState!=MouseState.Enter) {
			    currentMouseState = MouseState.Enter;
                need=210;
		    }
	    }
	    ...
	    protected override void OnMouseLeave(EventArgs e) {
		    base.OnMouseLeave(e);
		    if (currentMouseState!=MouseState.None) {
			    currentMouseState = MouseState.None;
                need=240;
		    }
	    }
	    ...
	    protected override void OnMouseDown(MouseEventArgs mevent) {
		    ...
		    if (currentMouseState!=MouseState.Click) {
			    currentMouseState = MouseState.Click;
                need=170;
		    }
	    }
        ...
        protected override void OnPaint(PaintEventArgs e) {
            ...
            if (disamble) {
                ...
                b = new LinearGradientBrush(ClientRectangle, Color.FromArgb(alpha-20, alpha-20, alpha-20), Color.FromArgb(alpha-20-10, alpha-20-10, alpha-20-10), 90);
            } else {
                b = new LinearGradientBrush(ClientRectangle, Color.FromArgb(alpha, alpha, alpha), Color.FromArgb(alpha-10, alpha-10, alpha-10), 90);
                sb = new Pen(new SolidBrush(Color.DarkGray));
            }
            ...
            using (Bitmap nb=new Bitmap(buttonSize.Width, buttonSize.Height)) {
                ...
                if (MouseState.None==currentMouseState) {
                    //if (shadow!=null) {
                ...
                } else if (MouseState.Click==currentMouseState) {
                    g.DrawImage(nb, new Point(1, 1));
                    NativeMethods.Text(g, Constants.font14, Text, pos.X, pos.Y,255);
                } else {
                    //if (shadow!=null) {
            ...
            if (Collapsed) g.DrawImage(imageDown,ptImageDown);
            else  g.DrawImage(imageUp,ptImageDown);

            Image currentImage;
            switch (currentState){ 
                case GCheckState.State.OK:
                    currentImage=imageOk;
                    break;

                default:
                    currentImage=imageWarling;
                    break;

                case GCheckState.State.Wrong:
                    currentImage=imageWrong;
                    break;
            }
            g.DrawImage(imageLogo,new Point(5+34,2));
            g.DrawImage(currentImage, new Rectangle(2,2,32,32));
        }
